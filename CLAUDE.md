...
#### **優先度高（次のブランチ）**
1. **08_post_listing_#10**: 投稿一覧・検索・ソート機能（**進行中**）
   - ✅ 検索機能（title・descriptionでのキーワード検索）
   - ✅ ソート機能（新着順・古い順）
...
### 🚧 開発中ブランチ
- **08_post_listing_#10**: 投稿一覧・検索・ソート機能（**進行中**）
  - Task 1: 基本的な投稿一覧機能の拡張（**完了**）
  - Task 2: 検索機能のUI実装（**完了**）
  - Task 3-8: ソート機能、ページネーション、テスト等（**未実装**）

### 🚀 次の開発予定
- **08_post_listing_#10**: 残りタスク完了・マージ準備
